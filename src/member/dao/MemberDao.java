...
public class MemberDao {
		...
		try {
			...
			if(rs.next()) {
				member = new Member(rs.getString("memberid"), 
						rs.getString("name"), rs.getString("password"), toDate(rs.getTimestamp("regdate"))); //toDate 안하면 어떻게 될까
			} return member;
	...
	private void insert(Connection conn, Member mem) throws SQLException {
